...
class HoverEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        ### MODIFICATION: REMOVED success_hold_timesteps, success_timer_buf, and episode_has_success ###
        # These are no longer needed as we are not resetting mid-episode.
    ...
    def step(self, actions):
        ...
        ### MODIFICATION: THE ENTIRE LOGIC BLOCK FOR MID-EPISODE RESAMPLING HAS BEEN REMOVED ###
        # The target now remains static for the entire episode.
    ...
    def reset_idx(self, envs_idx):
        ...
        ### MODIFICATION: Removed reset of success_timer_buf ###
        ...
        ### MODIFICATION: Removed logging and reset of episode_has_success ###
